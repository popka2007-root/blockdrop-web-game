export const format = {
  ...
  level: (value, language = "ru") => language === "en" ? `Level ${value}` : `\u0423\u0440\u043e\u0432\u0435\u043d\u044c ${value}`,
  lines: (value, language = "ru") => language === "en" ? `${value} lines` : `${value} \u043b\u0438\u043d\u0438\u0439`,
  combo: (value, language = "ru") => value > 1 ? (language === "en" ? `${value}x combo!` : `${value}x \u043a\u043e\u043c\u0431\u043e!`) : "",
...
export const calc = {
  progress: (current, target) => target > 0 ? Math.min(current / target, 1) : 0,
