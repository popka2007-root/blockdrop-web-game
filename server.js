...
const { createHttpService } = require("./server-http");
const { assertServerContracts } = require("./server-contracts");
...
const server = http.createServer(httpService.handler);
...
pruneProductData();
const productDataPruneTimer = setInterval(pruneProductData, 60 * 60 * 1000);
